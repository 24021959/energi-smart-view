...
// Temporary Mapbox token - in a production app, use environment variables or Supabase secrets
mapboxgl.accessToken = 'pk.eyJ1IjoibG92YWJsZWRldiIsImEiOiJjbDQwdzN2dTIwYzVqM2lsYXB2bzA0dWRoIn0.qS-5vhoz0Chi2Lgr8_x-dA';
            ...
            <div className="relative w-full h-[400px] rounded-lg overflow-hidden border border-gray-200">
              ...
              {!location && (
                <div className="absolute inset-0 flex items-center justify-center bg-gray-100">
                  <p>Impossibile caricare la mappa per questa località.</p>
                </div>
              )}
            </div>
